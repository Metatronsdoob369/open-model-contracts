...
local Global = require(script.Parent.Broken_Global_Reference) -- STRUCTURAL FRACTURE: Broken Dependency
local Players = Global.Players
local Houses = Global.Houses
local Environment = nil -- STRUCTURAL FRACTURE: Missing Environment Anchor
