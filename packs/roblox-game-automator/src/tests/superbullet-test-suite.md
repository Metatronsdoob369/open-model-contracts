...
# Point to real services (optional; falls back to mocks if unset)
export EMBED_URL=http://localhost:8073/embeddings    # a-mem-3072-refrag
export QDRANT_URL=http://localhost:6333
export QDRANT_COLLECTION=refrag-3072
export BROKEN_LUA=/Users/joewales/NODE_OUT_Master/open-model-contracts/workspace/gen/job2-stubs/full/pizza-superbullet.lua  # optional: real-world broken specimen
