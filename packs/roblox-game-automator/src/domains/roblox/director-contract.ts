...
// Source of truth: popsim-contract/src/domains/roblox/director-contract.ts
// Mirrored into pack src so rootDir compilation stays clean.
...
export const ParsedIntentSchema = z.object({
  ...
  thoughtProcess: z.array(z.string()).optional(), // Semantic deconstruction labeling
...
export const SpecialistBriefSchema = z.object({
  ...
  estimatedModules: z.array(z.string()),
});
