...
may be admitted as a valid jurisdiction inside Open Model-Contracts.

This is not a description of MCP.
This is not a guarantee of trust.
This is an admission contract.

Open Model-Contracts remains tool-agnostic.
...
- whether an MCP server may exist inside Open Model-Contracts
...
This contract does not supersede Open Model-Contracts invariants.
...
without changing Open Model-Contracts law.

Open Model-Contracts does not depend on MCP.
